...
import { Bell, Calendar as CalIcon, Settings, Users, Megaphone, Briefcase, ClipboardList, BarChart3, Download, FileText, Star, Sparkles, LayoutDashboard, PlusCircle, Building2, QrCode, Activity } from "lucide-react";
...
const NAV: Array<{ to: any; label: string; icon: any; exact?: boolean }> = [
  ...
  { to: "/admin/attendance", label: "Live Attendance", icon: Activity },
